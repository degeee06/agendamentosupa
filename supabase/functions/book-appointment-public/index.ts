...
serve(async (req: Request) => {
  ...
  try {
    ...
    // 5. Marca o link como utilizado IMEDIATAMENTE para evitar conflitos.
    // Se o pagamento não for feito, o link é "perdido", o que é um comportamento seguro para evitar double-booking.
    ...
    // 6. Envia notificação de broadcast (o dashboard verá como 'Aguardando Pagamento')
    ...
    // NOTA: Não enviamos Push Notification aqui. Isso será feito pelo webhook do Mercado Pago quando confirmado.
